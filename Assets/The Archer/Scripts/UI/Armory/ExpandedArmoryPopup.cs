...
namespace OctoberStudio.UI.Armory
{
    public abstract class ExpandedArmoryPopup : MonoBehaviour
    {
        ...
        protected Sprite upgradeButtonSprite;
        ...
        protected virtual void Awake()
        {
            ...
            upgradeButtonSprite = upgradeButton.image.sprite;
        ...
        {
            GameController.Gold.OnAmountChanged += OnGoldAmountChanged;
        ...
        protected virtual void OnGoldAmountChanged(int amount)
        {
            InitVisuals();
        }
