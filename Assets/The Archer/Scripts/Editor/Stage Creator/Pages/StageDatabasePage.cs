...
namespace OctoberStudio.StageCreator
{
    public class StageDatabasePage
    {
        ...
        protected virtual void DrawStageData(StageListItem selectedStage)
        {
            ...
            stageObjectiveProperty.stringValue = GUILayout.TextArea(stageObjectiveProperty.stringValue, GUILayout.Width(200), GUILayout.Height(EditorGUIUtility.singleLineHeight * 2));
            EditorGUILayout.EndHorizontal();
