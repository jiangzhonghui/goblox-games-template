...
namespace OctoberStudio.UI.Armory
{
    public class ExpandedHeroPopup : ExpandedArmoryPopup
    {
        ...
        protected virtual void InitButtonsUpgradable()
        {
            ...
            upgradeButtonLabel.SetAmount(cost);

            if (cost <= GameController.Gold.Amount)
            {
                upgradeButton.enabled = true;
                upgradeButton.image.sprite = upgradeButtonSprite;
        ...
        protected virtual void InitButtonsNotBought()
        {
            ...
            var cost = Data.GetHeroLevel(0).Cost;
        ...
        protected override void OnUpgradeButtonClicked()
        {
            ...
            var cost = Data.GetHeroLevel(SaveData.Level).Cost;
            GameController.Gold.Withdraw(cost);
